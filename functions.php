...
// Add Actions
add_action( 'init', 'ks_scripts' ); // Add  Scripts
add_action( 'get_header', 'enable_threaded_comments' ); // Enable Threaded Comments
add_action( 'wp_enqueue_scripts', 'ks_styles' ); // Add Theme Stylesheet
add_action( 'init', 'register_ks_menu' ); // Add HTML5 Blank Menu
add_action( 'init', 'ks_create_post_type' ); // Add our HTML5 Blank Custom Post Type
add_action( 'widgets_init', 'ks_remove_recent_comments_style' ); // Remove inline Recent Comment Styles from wp_head()
add_action( 'init', 'ks_pagination' ); // Add our HTML5 Pagination
...
// Add Filters
add_filter( 'avatar_defaults', 'ks_blankgravatar' ); // Custom Gravatar in Settings > Discussion
...
add_filter( 'excerpt_more', 'ks_blank_view_article' ); // Add 'View Article' button instead of [...] for Excerpts
add_filter( 'show_admin_bar', 'remove_admin_bar' ); // Remove Admin bar
add_filter( 'style_loader_tag', 'ks_style_remove' ); // Remove 'text/css' from enqueued stylesheet
